...
namespace Game1
{
    ...
    {    
        public HexaBoard(int width, int height, int nHoles, int nBoxes, int nEnemies, int nCollectibles, int nPortals, int nDirections, Game1 game) : base(width, height, nHoles, nBoxes, nEnemies, nPortals, nCollectibles, nDirections, game)
        {
