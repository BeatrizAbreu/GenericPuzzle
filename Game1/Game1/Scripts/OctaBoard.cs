...
namespace Game1.Scripts
{
    class OctaBoard : Board
    {
        ...
        public OctaBoard(int width, int height, int nHoles, int nBoxes, int nCollectibles, int nEnemies, int nPortals, int nLasers, int nDirections, Game1 game) : base(width, height, nHoles, nBoxes, nCollectibles, nEnemies, nPortals, nLasers, nDirections, game)
        {
